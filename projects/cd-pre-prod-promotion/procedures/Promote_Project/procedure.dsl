...
'''
  ...
  formalParameter 'git-push-cred-bash', {
    description = 'Ensure to select the same credential used for the EC-Git configuration. Use a personal access token.'
    dependsOn = 'ec-git_configuration'
    expansionDeferred = '0'
    label = 'Git Push Credential'
    orderIndex = '7'
    renderCondition = '${ec-git_configuration} != \'\''
    required = '0'
    type = 'credential'
  }
}
